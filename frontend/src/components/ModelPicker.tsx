...
export default function ModelPicker({ value, options, onChange, placeholder = "auto" }: Props) {
  ...
  const menu = open && pos ? (
    <div className="model-menu" role="listbox" style={{ position: "fixed", left: pos.left, width: pos.width, bottom: pos.bottom, top: "auto", zIndex: 9999, opacity: 1, transform: "none", pointerEvents: "auto" }}>
      {all.map((opt, i) => {
